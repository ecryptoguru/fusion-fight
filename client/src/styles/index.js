const styles = {
  ...
  hocLogo: "w-[128px] h-[128px] object-contain cursor-pointer",
  ...
  btn: "px-4 py-2 rounded-lg bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 w-fit text-white font-rajdhani font-bold",
